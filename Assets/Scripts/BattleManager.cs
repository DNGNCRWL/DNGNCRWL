...
public class BattleManager : MonoBehaviour
{
    ...
    //**** ACTIONS ****//
    bool Attack(GameObject attacker, GameObject target)
    {
        CharacterSheet aCS = attacker.GetComponent<CharacterSheet>();
        CharacterSheet tTS = target.GetComponent<CharacterSheet>();
